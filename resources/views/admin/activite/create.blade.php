...
@section('title', 'Ajout de activite ' )
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="block block-rounded">
                    <div class="card-body">
                        <a href="{{ url('/admin/activite') }}" title="Retour"><button class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</button></a>
                        <br />
                        <br />
                        ...
                        {!! Form::open(['url' => '/admin/activite', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin.activite.form', ['formMode' => 'create'])
