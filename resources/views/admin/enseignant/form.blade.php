...
<div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group{{ $errors->has('prenom') ? 'has-error' : ''}}">
        {!! Form::label('prenom', 'Prénom', ['class' => 'control-label']) !!}
...
<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group{{ $errors->has('specialite') ? 'has-error' : ''}}">
            {!! Form::label('specialite', 'Spécialité', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('ecole') ? 'has-error' : ''}}">
    ...
    {!! Form::text('ecole', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('biographie') ? 'has-error' : ''}}">
    ...
    {!! Form::textarea('biographie', null, ('' == 'required') ? ['class' => 'form-control crud-richtext','rows'=>"10", 'required' => 'required'] : ['class' => 'form-control crud-richtext','rows'=>"15"]) !!}
