...
@section('title', 'Affichage de Filiere #'.$filiere->id )
    ...
    <div
        ...
        <div class="flex-grow-1 mb-1 mb-md-0">
            ...
            <h2 class="h6 fw-medium fw-medium text-muted mb-0">
               Affichage de Filiere #{{$filiere->id  }}
            </h2>
        </div>
            ...
            <div class="col-md-9">
                <div class="block block-rounded">                                    
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/filiere/' . $filiere->id . '/edit') }}" title="Edit Filiere"><button class="btn btn-alt-primary btn-sm"><i class="si si-note" aria-hidden="true"></i> Edit</button></a>
                        {!! Form::open([
                            'method'=>'DELETE',
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $filiere->id }}</td>
                                    </tr>
                                    <tr><th> Nom </th><td> {{ $filiere->nom }} </td></tr><tr><th> Sigle </th><td> {{ $filiere->sigle }} </td></tr><tr><th> Description </th><td> {{ $filiere->description }} </td></tr>
                                </tbody>
                            </table>
                        </div>
