...
@section('title', 'Affichage de Avis #'.$avis->id )
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="block block-rounded">                                    
                    <div class="card-body">
                        <a href="{{ url('/admin/avis') }}" title="Back" autofocus><button class="btn btn-secondary btn-sm" ><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</button></a>
                        <a href="{{ url('/admin/avis/' . $avi->id . '/edit') }}" title="Edit Avi"><button class="btn btn-alt-primary btn-sm"><i class="si si-note" aria-hidden="true"></i> Edit</button></a>
                        {!! Form::open([
                            'method'=>'DELETE',
                            'url' => ['admin/avis', $avi->id],
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $avi->id }}</td>
                                    </tr>
                                    <tr><th> Nom Prenom </th><td> {{ $avi->nom_prenom }} </td></tr><tr><th> Fonction </th><td> {{ $avi->fonction }} </td></tr><tr><th> Avis </th><td> {{ $avi->avis }} </td></tr>
                                </tbody>
                            </table>
                        </div>
