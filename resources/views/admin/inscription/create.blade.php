...
@section('title', 'Ajout de inscription ' )
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="block block-rounded">
                    <div class="card-body">
                        <a href="{{ url('/admin/inscription') }}" title="Retour" autofocus><button class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</button></a>
                        <br />
                        <br />
                        ...
                        {!! Form::open(['url' => '/admin/inscription', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin.inscription.form', ['formMode' => 'create'])
