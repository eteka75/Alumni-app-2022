...
@section('title', 'Affichage de Message #'.$message->id )
    ...
    <div
        ...
        <div class="flex-grow-1 mb-1 mb-md-0">
            ...
            <h2 class="h6 fw-medium fw-medium text-muted mb-0">
               Affichage de Message #{{$message->id  }}
            </h2>
        </div>
            ...
            <div class="col-md-9">
                <div class="block block-rounded">                                    
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/message/' . $message->id . '/edit') }}" title="Edit Message"><button class="btn btn-alt-primary btn-sm"><i class="si si-note" aria-hidden="true"></i> Edit</button></a>
                        {!! Form::open([
                            'method'=>'DELETE',
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Site </th><td> {{ $message->site }} </td></tr>
                                    <tr><th> Email </th><td> {{ $message->email }} </td></tr>
                                    <tr><th> Objet </th><td> {{ $message->objet }} </td></tr>
                                    <tr><th> Nom </th><td> {{ $message->nom }} </td></tr>
