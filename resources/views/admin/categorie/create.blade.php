        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="block block-rounded">
                    <div class="card-body">
                        <a autofocus href="{{ url('/admin/categorie') }}" title="Retour"><button class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</button></a>
                        <br />
                        <br />
                        ...
                        {!! Form::open(['url' => '/admin/categorie', 'class' => 'form-horizontal', 'files' => true]) !!}
