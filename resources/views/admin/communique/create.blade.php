...
@section('title', 'Ajout de communiqué ' )
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="block block-rounded">
                    <div class="card-body">
                        <a href="{{ url('/admin/communique') }}" title="Retour" autofocus><button class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</button></a>
                        <br />
                        <br />
                        ...
                        {!! Form::open(['url' => '/admin/communique', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin.communique.form', ['formMode' => 'create'])
