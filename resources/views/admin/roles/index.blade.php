                            ...
                            <table class="table">
                                ...
                                @foreach($roles as $item)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ url('/admin/roles/' . $item->id) }}" title="View Role"><button class="btn btn-info btn-sm"><i class="si si-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/admin/roles/' . $item->id . '/edit') }}" title="Edit Role"><button class="btn btn-primary btn-sm"><i class="si si-note" aria-hidden="true"></i></button></a>
                                           <!-- {!! Form::open([
                                                'method' => 'DELETE',
