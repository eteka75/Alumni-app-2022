    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 mt-5">
                <img class="img-fluid pe-sm-4 " src="{{ asset('storage/assets/images/etu_fm.jpg') }}">
            </div>
            <div class="col-md-4 mt-5">
                <div class="card_p-5 shadow-smç rounded-3 border mb-5">
                    ...
                    <div class="text-center mb-4">
                        <h3>{{ __('Réinitialisation de mot de passe Password') }}</h3>
                        <small>Entrez votre mot de passe pour réinitialiser votre compter</small>
