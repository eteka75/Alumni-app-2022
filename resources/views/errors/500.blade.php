...
<html lang="fr">
    ...
    <body class="antialiased bg-white ">
        ...
        <div class="py-2">
        <div class="sa-error text-center">
            <div class="py-2 clearfix text-center ">
                <a class="navbar-brand" href="/">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="CFPS DON BOSCO" class="img-fluid_ mx-auto" id="top_logo">
                </a>
            </div>
            <div class="sa-page-content container">
                <div class="error-404 not-found">
                    ...
                    <!-- /.sa-logo -->  
                    <img src="{{ asset('assets/images/500.jpg') }}" alt="Image" class="img-fluid">               
                    <h1 class="h2s">Une erreur est survenue sur le serveur... </h1>                       
                    <a class="btn btn-primary  mt-2" href="{{ url('/') }}"> Retour à l'accueil </a>
                </div><!-- .sa-page-content -->
            </div><!-- /.not-found -->            
        </div><!-- /.sa-error -->
        </div>
