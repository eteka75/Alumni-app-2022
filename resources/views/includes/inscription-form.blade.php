<div class="row">
    <div class="col-12">
        <h5 class="text-lg text-primary">Informations sur l'apprenant</h5>
        <hr class="mb-3 m-0">
    </div>
...
<div class="row">
    <div class="col-12">
        <h5 class="text-lg text-primary">Informations sur les parents</h5>
        <hr class="mb-3 m-0">
    </div>
    <div class="col-md-6 mb-2">
...
<div class="row">
    <div class="col-12">
        <h5 class="text-lg text-primary">Choix de la formation</h5>
        <hr class="mb-3 m-0">
    </div>
    <div class="col-md-6 mb-2">
...
<div class="form-group {{ $errors->has('photo') ? 'has-error' : '' }}">
    {!! Form::label('photo', "Photo d'identité (Format Image ou PDF *)", ['class' => 'control-label bold']) !!}
    {!! Form::file('photo', 'required' == 'required' ? ['class' => 'form-control', 'required' => 'required','accept'=>'.pdf,.jpg,.jpeg,.png'] : ['accept'=>'.pdf','accept'=>'.pdf,.jpg,.jpeg,.png','class' => 'form-control']) !!}
    {!! $errors->first('photo', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('acte_de_naissance') ? 'has-error' : '' }}">
    {!! Form::label('acte_de_naissance', 'Acte de naissance (Format Image ou PDF *)', ['class' => 'control-label bold']) !!}
    {!! Form::file('acte_de_naissance', 'required' == 'required' ? ['class' => 'form-control', 'required' => 'required','accept'=>'.pdf,.jpg,.jpeg,.png'] : ['accept'=>'.pdf,.jpg,.jpeg,.png','class' => 'form-control']) !!}
    {!! $errors->first('acte_de_naissance', '<p class="help-block">:message</p>') !!}
</div>
</div>
        <div class="col-md-12 mb-2">
<div class="form-group {{ $errors->has('dernier_bulletin') ? 'has-error' : '' }}">
    {!! Form::label('dernier_bulletin', 'Dernier Bulletin (Format PDF *)', ['class' => 'control-label bold']) !!}
    {!! Form::file('dernier_bulletin', 'required' == 'required' ? ['class' => 'form-control', 'required' => 'required','accept'=>'.pdf'] : ['accept'=>'.pdf','class' => 'form-control']) !!}
    {!! $errors->first('dernier_bulletin', '<p class="help-block">:message</p>') !!}
</div>
</div>
</div>
<div class="form-group {{ $errors->has('certificat') ? 'has-error' : '' }}">
    {!! Form::label('certificat', 'Certificat de scolarité (Format PDF *)', ['class' => 'control-label bold']) !!}
    {!! Form::file('certificat', 'required' == 'required' ? ['class' => 'form-control', 'required' => 'required','accept'=>'.pdf'] : ['accept'=>'.pdf','class' => 'form-control']) !!}
